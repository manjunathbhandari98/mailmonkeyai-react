...
type EmailGenerationFormData = z.infer<typeof emailGenerationSchema>;
...
const EmailGenerator = () => {
  ...
  const onSubmit = async (data: EmailGenerationFormData) => {
    try {
      ...
      This is a ${data.tone} ${data.emailType} generated by MailMonkey AI.
    ...
    `;
      ...
      setTimeout(() => {
        setGeneratedEmail(fakeResponse.trim());
